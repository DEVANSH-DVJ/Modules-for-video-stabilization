...
if __name__ == '__main__':
    ...
    for isp, setpoint in setpoints.iterrows():
        ...
        video_s = cv2.VideoWriter('{}/s1.mp4'.format(out_dir), codec,
                                  fps, (size, size))
        video_u = cv2.VideoWriter('{}/u1.mp4'.format(out_dir), codec,
                                  fps, (size, size))
